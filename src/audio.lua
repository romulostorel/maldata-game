...
local SFX = {
    ...
    monster_remove         = { gen = sfx_gen.monster_remove,         volume = 0.55 },
    hero_footstep          = { gen = sfx_gen.hero_footstep,          volume = 0.20, variants = 4 },
    hero_attack_warrior    = { gen = sfx_gen.hero_attack_warrior,    volume = 0.55, variants = 3 },
    hero_attack_archer     = { gen = sfx_gen.hero_attack_archer,     volume = 0.50, variants = 3 },
    hero_attack_mage       = { gen = sfx_gen.hero_attack_mage,       volume = 0.50, variants = 3 },
